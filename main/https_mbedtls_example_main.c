...
#define WEB_SERVER CONFIG_API_SERVER
#define WEB_PORT CONFIG_API_PORT
#define WEB_URL CONFIG_API_URL
...
static void https_get_task(void *pvParameters)
{
    ...
    ret = mbedtls_x509_crt_parse(&clicert, client_cert_pem_start,
    ...
    ret = mbedtls_pk_parse_key(&pkey, client_key_pem_start,
